...
std::vector<cricket::VideoFormat> AndroidVideoCapturerJni::GetSupportedFormats()
{
                                                  ...
                                                  int64_t timestamp_ns)
{
    ...
    capturer_->OnFrame(cricket::WebRtcVideoFrame(
                           ...
                           translated_camera_time_us),
                       width, height);
} // AndroidVideoCapturerJni::OnMemoryBufferFrame
                                             ...
                                             const NativeHandleImpl& handle)
{
    ...
    capturer_->OnFrame(
        cricket::WebRtcVideoFrame(
            ...
            translated_camera_time_us),
        width, height);
} // AndroidVideoCapturerJni::OnTextureFrame
...
JNIEnv * AndroidVideoCapturerJni::jni()
{
