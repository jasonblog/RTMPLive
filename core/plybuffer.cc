...
#define PLY_MIN_TIME  500
#define PLY_MAX_TIME  600000
#define PLY_RED_TIME  250
#define PLY_MAX_DELAY 1000
#define PLY_MAX_CACHE 16
#define PB_TICK       1011
...
void PlyBuffer::SetCacheSize(int miliseconds)
{
    if (miliseconds > 500 && miliseconds <= 600000) {
