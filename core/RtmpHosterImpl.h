...
class RtmpHosterImpl : public RTMPHoster, public AnyRtmpstreamerEvent, rtc::MessageHandler
    , public webrtc::AVAudioRecordCallback
{
public:
...
#endif // ifndef __RTMP_HOSTER_IMPL_H__
