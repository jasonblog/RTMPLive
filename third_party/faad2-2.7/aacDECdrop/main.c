...
ReadIniFile(FILE* fp)
{
    ...
    while (fgets(buff, sizeof buff, fp) != NULL) {
        if (1 == sscanf(buff, "Window_X=%d", &val)) {
            iniSettings.window_x      = val;
        } else if (1 == sscanf(buff, "Window_Y=%d", &val)) {
            iniSettings.window_y      = val;
        } else if (1 == sscanf(buff, "Always_on_top=%d", &val)) {
            iniSettings.always_on_top = val;
        } else if (1 == sscanf(buff, "Logerr=%d", &val)) {
            iniSettings.logerr        = val;
        } else if (1 == sscanf(buff, "DecodeMode=%d", &val)) {
            iniSettings.decode_mode   = val;
        } else if (1 == sscanf(buff, "OutputFormat=%d", &val)) {
            iniSettings.outputFormat  = val;
        } else if (1 == sscanf(buff, "FileType=%d", &val)) {
            iniSettings.fileType      = val;
        } else if (1 == sscanf(buff, "ObjectType=%d", &val)) {
            iniSettings.object_type   = val;
        }
    }
